...
public class PerfilGeneral {
    ...
    public Map<Edificio, DatosRobotEdificio> obtenerDatosPorEdificio(AdmEdificio AdmEdificio) {
        ...
        for (Edificio edificio : listaEdificios) {
            ...
            //System.out.println("Datos " +total +" " +enAlerta);
            int porcentaje = 0;
            if (total == 0 | enAlerta == 0){
                porcentaje = 0;
            } else {
            porcentaje = enAlerta*100/total;
            }
    ...
    public int porcentajeCargaficiosDisponibles(AdmCargaficios AdmCargaficios){
        ...
        System.out.println(AdmCargaficios.CargaficiosDisponibles());
    ...
    public ArrayList desgloseEnergia(AdmCargaficios admCargaficios, String idCargaficio){
        ArrayList info = new ArrayList<>();
        Cargaficio unCargaficio = admCargaficios.consultar(idCargaficio);
        ...
        int capacidad = unCargaficio.getCapacidadMaxima();
        info.add(id);
        info.add(estado);
        info.add(capacidad);
        info.add(ocupacion);
    ...
    public ArrayList desgloseEdificios(AdmEdificio AdmEdificio, String idEdificio){
        ArrayList info = new ArrayList<>();
        Edificio unEdificio = AdmEdificio.consultar(idEdificio);
